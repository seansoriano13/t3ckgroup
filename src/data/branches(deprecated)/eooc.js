export const eeoc = [
  ...
  // --- 2. PRODUCT SPOTLIGHT (UNIFIED COMMAND SYSTEM) ---
  {
    ...
    data: {
      ...
      description:
        "The EEOC Command Suite integrates real-time dispatch, network monitoring, and proprietary analytics platforms into a single, high-availability dashboard for seamless emergency coordination.",
        ...
        options: [
          {
            id: "01",
            label: "CLOUD HOSTING",
            caption: "24/7 Redundant server uptime.",
            featureImage: "/assets/products/eeoc-cloud.jpg",
          },
          {
            id: "02",
            label: "MOBILE DISPATCH",
            caption: "Cross-platform field applications.",
            featureImage: "/assets/products/eeoc-app.jpg",
          },
          {
            id: "03",
            label: "TEXT BROADCAST",
            caption: "Mass notification & email blast.",
            featureImage: "/assets/products/eeoc-sms.jpg",
          },
          {
            id: "04",
            label: "ERP INTEGRATION",
            caption: "HRIS, Payroll, & Enterprise Management.",
            featureImage: "/assets/products/eeoc-erp.jpg",
          },
        ],
      },
    },
  ...
  // --- 3. CAPABILITIES (SYSTEMS & INFRASTRUCTURE) ---
  {
    ...
    data: [
      ...
      },
      {
        ...
        description:
          "Native and cross-platform applications built for field responders and command center operators to ensure real-time reporting and analytics.",
    ...
    data: {
      ...
      activities: [
        ...
        },
        {
          ...
          description:
            "Mass rollout of localized retail and queuing solutions.",
  ...
  // --- 5. CONTACT SECTION ---
  {
    ...
    data: {
      ...
      description:
        "Explore our unified command architecture designed to optimize emergency response through integrated dispatch and reporting.",
